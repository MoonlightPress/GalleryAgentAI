...
Legitimate Tokyo government-funded arts institution with residencies and exhibitions, but currently no accessible application information.

## 5. Existing Fit Notes
Culturally appropriate institutional context for your practice themes and geographic focus, but requires significant investigative work to identify actual opportunities.

## 6. Key Points
- Established institutional venue operating multiple spaces across Tokyo—genuine credential if accepted
- Strong thematic fit for work engaging Asian urban spaces and cultural documentation
...
Bookmark for systematic research later—not urgent without active deadline
