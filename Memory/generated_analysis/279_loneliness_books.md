...
- **Official/source website**: https://www.instagram.com/lonelinessbooks/ (verified)
- **Submission process**: Not publicly listed (needs_inquiry)
- **Deadline**: December 10, 2025 (verified)
...
Independent book/zine signal near Nakano. Possible secondary local target after Tacoche.

## 5. Existing Fit Notes
Independent book/zine signal near Nakano. Possible secondary local target after Tacoche.

## 6. Key Points
- Type: independent books zines.
- Location: Nakano, Tokyo.
- First action: Verify whether it is active and whether it has a physical sales route.
...
Verify whether it is active and whether it has a physical sales route.
