...
Potential fit based on source context and keyword overlap: open call, portfolio review for works on paper for works on paper, watercolor / works on paper

## 6. Key Points
- Automatically discovered candidate.
- Needs verification before being treated as actionable.
- Keyword hits: open call, portfolio review for works on paper for works on paper, watercolor / works on paper
