...
- **Official/source website**: https://www.instagram.com/ilovetoys_magazine/ (verified)
- **Submission process**: Not publicly listed (needs_inquiry)
- **Deadline**: ongoing (verified)
- **Fees**: Free (verified)
- **Contact**: Via WeChat official accounts, Weibo DM, or Instagram DM @ilovetoys_magazine (verified)

## 3. Why This May Fit the Artist
- Opportunity type: Press Target.
...
Chinese illustration magazines actively looking for overseas Chinese artists. You're Chinese, in Tokyo, with 26k followers — strong story for Chinese art audiences.

## 5. Existing Fit Notes
You're Chinese. 'Chinese artist documenting Tokyo through watercolor' is exactly the cross-cultural story these publications want. Near-term opportunity with lower competition than Japanese press.

## 6. Key Points
- Check the official website for current submission guidelines and open call status
- Based in Shanghai, China — confirm this matches your geographic focus before investing preparation time
...
Pitch via WeChat DM or Weibo. Chinese-language pitch. Lead with the Beijing/Chinese-artist-in-Tokyo angle.
