...
- **Mall Galleries Open Exhibitions** — path score 11.8; signals: works on paper, painting, open exhibition. Open exhibition context for painting, drawing, or works on paper. Good candidate for direct verification.
...
- **【biscuit gallery】初の公募企画「grid next : Emerging ...** — path score 11.2; signals: gallery, works on paper. 【biscuit gallery】初の公募企画「grid next : Emerging ... may fit if its past artists show quiet contemporary work, watercolor / works on paper, drawing, atmosphere, or place-based themes.
- **グループ展参加アーティスト募集中 - Gallery and Links81** — path score 11.2; signals: gallery, works on paper. グループ展参加アーティスト募集中 - Gallery and Links81 may fit if its past artists show quiet contemporary work, watercolor / works on paper, drawing, atmosphere, or place-based themes.
...
- **Mall Galleries Open Exhibitions** — path score 13.6; signals: works on paper, drawing, painting, watercolor, open exhibition, paper. Open exhibition context for painting, drawing, or works on paper. Good candidate for direct verification.
...
- **CLOUDS Gallery+Coffee Koenji** — path score 11.59; signals: cafe, local, gallery. Gallery-primary space with international artist program. Explicitly shows emerging and established artists from Japan and abroad. Best gallery-cafe match in Koenji.
