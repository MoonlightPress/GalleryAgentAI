...
- **ART SG 2026** (was: `stretch_targets`) — Major Singapore art fair in 2026 featuring Chinese artists and contemporary work; relevant
...
- **Tokyo Gendai 2026** (was: `stretch_targets`) — Fourth edition art fair in Tokyo, September 11-13, 2026, with gallery applications open.
...
- **第10屆溫哥華藝術博覽會 (Art Vancouver 2026)** (was: `stretch_targets`) — Tenth edition of Vancouver Art Fair showcasing contemporary art and design from Canadian a
...
- **The Light Frame Gallery | Open Call for Guest Writers (Museums, Photography & Community) S** (was: `none`) — Candidate link discovered from CuratorSpace.
...
- **RAW TOKYO** (was: `research_needed`) — Tokyo-based pop-up fair ecosystem that likely functions as a vendor marketplace rather tha