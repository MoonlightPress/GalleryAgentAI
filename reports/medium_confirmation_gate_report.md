...
- **Skipped (already reject/low_priority):** 16
- **Total:** 286
...
- **Koganecho Area Management Center** (was: `relationship_builders`) — Established artist-run center in Yokohama focused on site-responsive practice and communit
- **Shimokitazawa Arts** (was: `japan_book_ecosystem`) — Shimokitazawa gallery presenting monthly solo exhibitions by younger contemporary Japanese
...
- **3331 Arts Chiyoda** (was: `relationship_builders`) — 3331 Arts Chiyoda is a respected Tokyo artist-run space in a converted school building, kn
...
- **International Open Call** (was: `research_needed`) — Open Calls / Contests lead found through targeted research; useful if requirements and fit
- **AIR 3331** (was: `research_needed`) — Tokyo residency at established contemporary art center with strong geographic and thematic
- **Open Call for DIGITAL WORKS Open Call for artists. Send us your Digital Work to show in ou** (was: `research_needed`) — Candidate link discovered from CuratorSpace.
...
- **OPEN SITE 11** (was: `relationship_builders`) — Project proposal call for artist projects at TOKAS Hongo, a Tokyo-based artist-run space.
...
- **OPEN CALL for the Artist-In-Residence Program 2025/2026** (was: `research_needed`) — Residencies lead found through targeted research; useful if requirements and fit check out
- **MICRO/MACRO** (was: `relationship_builders`) — Group exhibition exploring micro and macro perspectives, relevant to GEGYjiji's urban obse
- **Yonchome Cafe** (was: `relationship_builders`) — Koenji cafe with unverified exhibition program - insufficient information to assess as leg
...
- **Audio Work Required - Artists and Friends Podcast - Open Call Artists and Friends is a Pod** (was: `research_needed`) — Candidate link discovered from CuratorSpace.
- **INSTINC 2026/2027 Artist-in-Residence Program** (was: `relationship_builders`) — Independent artist residency program emphasizing experimentation and artistic vision, open
...
- **第10屆溫哥華藝術博覽會 (Art Vancouver 2026)** (was: `relationship_builders`) — Tenth edition of Vancouver Art Fair showcasing contemporary art and design from Canadian a
- **Art Vancouver 2026** (was: `relationship_builders`) — Major art fair on Canada's West Coast presenting contemporary art and design works, access
...
- **ART FAIR TOKYO 21** (was: `research_needed`) — Major Tokyo art fair with open call for exhibitors; relevant for artists seeking fair boot
...
- **「国際創作者駐村計畫」** (was: `relationship_builders`) — International artist residency program inviting visual artists, filmmakers, designers and 
...
- **Gallery HANA Shimokitazawa** (was: `relationship_builders`) — Small Shimokitazawa gallery with insufficient public information to assess exhibition stan
...
- **Kyoto Art Center Residency** (was: `research_needed`) — Kyoto Art Center Residency may matter later if her portfolio package and project statement
- **AIR_J Open Calls** (was: `research_needed`) — AIR_J Open Calls may matter later if her portfolio package and project statement become st
- **NEW AIR** (was: `research_needed`) — NEW AIR may matter later if her portfolio package and project statement become strong enou
...
- **FACE Exhibition 2026** (was: `relationship_builders`) — Nationwide open-call for two-dimensional artworks that accepts diverse artistic expression
- **Gallery 191 Exhibition 2026** (was: `relationship_builders`) — Open call for visual artists working in a variety of media to exhibit in gallery space.
- **Art Submissions** (was: `research_needed`) — Candidate link discovered from ArtConnect Open Calls.
- **Callback Open Call G George invites you to submit to Callback, a series of contemporary ar** (was: `research_needed`) — Candidate link discovered from CuratorSpace.
- **Vault Collective ** OPEN CALL** Rolling Deadline **OPEN CALL** VAULT COLLECTIVE ** ROLLING** (was: `research_needed`) — Candidate link discovered from CuratorSpace.
- **第9回 国際公募 東京アート工芸2026** (was: `relationship_builders`) — International art and craft open call exhibition in Tokyo, May 14-24, 2026.
- **Tokyo Gendai 2026** (was: `relationship_builders`) — Fourth edition art fair in Tokyo, September 11-13, 2026, with gallery applications open.
...
- **2026 OCAA Ladies Art Exhibition** (was: `relationship_builders`) — Dedicated women artists exhibition by Toronto-based Chinese art association.
- **ART SG 2026** (was: `relationship_builders`) — Major Singapore art fair in 2026 featuring Chinese artists and contemporary work; relevant
