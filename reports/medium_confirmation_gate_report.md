...
- **Shimokitazawa Arts** (was: `immediate_best_moves`) — Shimokitazawa gallery presenting monthly solo exhibitions by younger contemporary Japanese
- **SUBMISSIONS - marblepress.com** (was: `publication_targets`) — Publishing / Small Press lead found through targeted research; useful if requirements and 
...
- **Submissions - Little Press Publishing** (was: `publication_targets`) — Publishing / Small Press lead found through targeted research; useful if requirements and 
...
- **ART BOX Publishing** (was: `publication_targets`) — Publishing / Small Press lead found through targeted research; useful if requirements and 
...
- **submissions for the 2026 set film festival are now open** (was: `research_needed`) — Candidate link discovered from ArtConnect Open Calls.
