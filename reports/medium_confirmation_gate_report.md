...
- **Hard-excluded (named exclusive to another medium):** 1
- **Skipped (already reject/low_priority):** 66
- **Total:** 1395

## Hard-excluded entries

- **第10回アキーラコンテスト** — exclusive to acrylic, not watercolor
...
- **2026年度 東京芸術文化鑑賞サポート助成** (was: `stretch_targets`) — Tokyo-based arts support program; accepts ongoing applications for creative activities.
...
- **National Endowment for the Arts FY 27 Grants for Arts Projects** (was: `stretch_targets`) — U.S. government arts grant program; eligibility for international artists not explicitly s
...
- **公益財団法人アイスタイル芸術文化財団 現代芸術振興助成 2026** (was: `stretch_targets`) — Supports contemporary art creation and exhibition; provides direct funding for visual arti
- **現代芸術振興助成** (was: `stretch_targets`) — Supports contemporary art creation and exhibition activities, accepts portfolio submission
- **国内クリエイター創作支援プログラム（2026年度）** (was: `stretch_targets`) — Government grant supporting new creative projects in media arts for emerging creators up t
...
- **Tokyo Arts Council 2026年度助成（創造活動助成）** (was: `stretch_targets`) — Tokyo metropolitan government grant supporting contemporary arts creation and internationa
- **Joan Mitchell Foundation Artist-in-Residence Program (2027)** (was: `stretch_targets`) — Supports visual artists for 2027 residencies with jury notification anticipated Fall 2026;
...
- **アジア文化芸術フェローシップ** (was: `stretch_targets`) — Supports individual artists based in Japan or ASEAN countries conducting research, creativ
- **2026 State of the Art Prize** (was: `stretch_targets`) — Unrestricted grant for individual artists; however, limited to one artist per U.S. state, 
- **海外展助成** (was: `stretch_targets`) — Japanese government grant for overseas exhibitions, supporting visual artists in presentin
...
- **海外派遣助成** (was: `stretch_targets`) — Japanese government grant for overseas deployment of cultural and arts professionals, supp
- **国内クリエイター発表支援プログラム（2026年度）** (was: `stretch_targets`) — Government grant for presenting completed works in media arts for creators age ~40 or unde
...
- **2026年度 芸術文化魅力創出助成 第1期 TOKYO CITY CANVAS助成** (was: `research_needed`) — Tokyo-based arts grant for visual artists supporting creative and cultural activities.
...
- **2027年度 リサーチ・レジデンス・プログラム** (was: `stretch_targets`) — Research residency program supporting artistic research and practice
- **Artist in Residence program in Paris 2026 / 2027** (was: `stretch_targets`) — International artist residency program for visual artists seeking overseas experience
...
- **2026年度　日本文化藝術奨学金** (was: `stretch_targets`) — Japanese cultural arts scholarship supporting visual and performing artists
...
- **National Gallery of Iceland CUSP Residency 2027** (was: `research_needed`) — International residency program with stipend; open to visual artists, though focused on co
- **東京芸術文化創造発信助成 カテゴリーⅠ、Ⅲ ［単年助成］ 第1期** (was: `research_needed`) — Tokyo arts grant supporting visual artists and cultural creation activities.
- **日本美術家連盟 若手作家制作活動支援給付金 2027年度** (was: `research_needed`) — Japan-based grant supporting emerging visual artists' production of new artwork in 2027.
...
- **Tokyo Live & Stage Support Grant Issue 1** (was: `research_needed`) — Tokyo-based government arts grant, though focus may be performance-oriented
...
- **TAF Artist Award 2027 - South Asia 2027** (was: `stretch_targets`) — Open call for visual artists in South Asia region, though geographically outside Tokyo may
- **アーティストの国際発信支援プログラム 2026年度第I期** (was: `stretch_targets`) — Government program supporting Japanese artists (including those based abroad) participatin
...
- **芸術文化助成** (was: `stretch_targets`) — Provides grants for young artist development and international cultural exchange activitie
- **Creative Capital Awards 2026** (was: `stretch_targets`) — Supports visual artists creating new works; no geographic restriction mentioned, but eligi
- **State of the Art Prize** (was: `stretch_targets`) — Provides unrestricted grants to artists in all 50 states and territories; eligibility crit
...
- **Japan Artist Residency Tokyo 2027 (Tokyo Arts and Space - TOKAS)** (was: `stretch_targets`) — Three-month artist residency in Tokyo for international creators with fully funded support
...
- **Research Residency Program** (was: `stretch_targets`) — Tokyo residency program for international and local artists to conduct research on arts an
...
- **新進芸術家海外研修制度における日本文化発信・普及事業（Japanese Cultural Promotion Project under the Emerging Artists Overseas Training Program）** (was: `stretch_targets`) — Supports emerging artists conducting research and activities abroad with funding for trave
...
- **2026 國內外藝術家交流計畫｜海外駐村徵件** (was: `research_needed`) — International artist residency program selecting 2 Taiwan-based young visual artists for 1
