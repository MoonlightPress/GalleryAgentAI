...
- **水彩アートの祭典「Watercolors 2026」** — 9.6. Watercolor-only exhibition at Tokyo Arts Theater, 2026 Mar 7-8, accepts watercolor works up to 4号 size with no theme restrictions
  - URL: https://nihonbungei.net/watercolors_2026
  - Next: verify current submission/contact details.
- **桜をテーマとするイラスト・絵画作品募集** — 9.6. Illustration and painting open call with cherry blossom theme, matching your illustration and observation-based practice.
  - URL: https://x.com/blueroses_news
- **アートオリンピア2026** — 9.6. Watercolour is an accepted medium and entry is online, so you can apply from the studio. Student fee (under 30) is roughly half the general fee — ¥6,000 for one work vs ¥12,000. Deadline July 31, 2026; exhibition is in Tokyo.
  - URL: https://www.artkoubo.jp/artolympia/
- **CSPWC Annual Open Water International Exhibition** — 9.6. Strict medium match — transparent watercolour only, which is your technique. International juried exhibition, entry is online (no shipping to enter), CAD $55 for non-members / $40 for members, up to 2 works. Notifications July 8; show runs Sept 1-19.
  - URL: https://cspwc.ca/
- **多摩ゆかりの作家による公募展** — 9.6. Open call for artists connected to the Tama region; welcomes watercolor and illustration submissions.
  - URL: https://x.com/yoshie_fukaura
- **Aquarelle 18 - アクワレル** — 9.6. Dedicated watercolor painting open call exhibition with booth display option matching your medium and practice.
  - URL: https://x.com/mado12_i
- **不透明水彩イラスト公募展 ニッカー絵具賞** — 9.6. Opaque watercolor and illustration open call with exhibition dates 2026/6/19–7/6, perfectly aligned with her watercolor practice.
  - URL: https://x.com/akikota_mikan
  - Next: verify current submission/contact details.
...
- **Jackson's Art Prize** — 9.6. Watercolor / Works On Paper prize / works-on-paper friendly opportunity. Useful for credibility if submission terms fit.
  ...
  - Next: verify current submission/contact details.
- **American Illustration** — 9.6. A possible place to show watercolor or works on paper.
  - URL: https://www.ai-ap.com/
- **World Illustration Awards** — 9.6. A possible place to show watercolor or works on paper.
  - URL: https://theaoi.com/world-illustration-awards/
  - Next: verify current submission/contact details.
- **Tokyo Illustrators Society** — 9.6. A possible place to show watercolor or works on paper.
...
- **Mograg Gallery** — 9.6. An active Tokyo gallery that programs emerging, un-repped Japanese artists by proposal — a real route in without a juried call. The work it shows leans contemporary/outsider, not polished or quiet, so don't take a 'fit' on trust: look at their recent shows and decide for yourself.
  - URL: https://mograg.com/
- **HATTIFNATT Koenji Cafe Gallery** — 9.6. A cafe-gallery in Koenji that regularly hangs illustration and painting, books by proposal with no fixed deadline — a low-barrier Tier-1 venue you can reach by phone. The space has a strong storybook/cute aesthetic, so look at it and decide if that's a register you want to sit in.
  - URL: https://www.hattifnatt.jp/
- **3x3 International Illustration Awards** — 9.6. A possible place to show watercolor or works on paper.
...
- **第50届悠美会国际美术展** — 9.6. International art exhibition accepting watercolor paintings and mixed media works in Tokyo
