...
- **Pola Art Foundation Grant** — 10.0 → 9.6 — promoted
- **American Watercolor Society Annual International Exhibition** — 9.96 → 9.6 — promoted
...
- **FACE展2026** — 8.99 → 9.6 — promoted
- **Gallery Rocket Harajuku** — 8.98 → 9.6 — promoted
- **Mall Galleries Open Exhibitions** — 8.97 → 9.6 — promoted
- **Route Books** — 8.85 → 9.6 — promoted
...
- **Royal Institute of Painters in Water Colours** — 7.24 → 8.04 — promoted
...
- **Japan Watercolor Society Annual Exhibition** — 6.8 → 7.6 — promoted
...
- **7月～12月企画展 参加者募集** — 6.07 → 6.87 — promoted
- **Boji Hair+Gallery** — 6.04 → 6.84 — promoted
- **Comitia** — 6.0 → 6.8 — promoted
- **RAW TOKYO** — 5.83 → 5.5 — demoted
- **Royal Watercolour Society** — 4.91 → 5.71 — promoted
