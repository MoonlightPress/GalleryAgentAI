...
- **水性繪畫展覽 (Watercolor Exhibition)** — 9.99 → 9.6 — promoted
- **2026 3rd Annual Illustration Summit Challenge (IlloBoom!)** — 9.9 → 9.6 — promoted
- **Mall Galleries Open Exhibitions** — 9.09 → 9.6 — promoted
...
- **アートオリンピア2026** — 8.77 → 9.57 — promoted
- **Applied Arts 2026 Illustration Awards** — 8.18 → 8.98 — promoted
- **FACE展2026** — 8.09 → 8.89 — promoted
- **2026东京·首届日中书画名家作品交流展 (2026 Tokyo First Japan-China Calligraphy and Painting Masters' Work Exchange Exhibition)** — 8.05 → 8.85 — promoted
- **B&B (Book & Beer)** — 8.0 → 8.8 — promoted
- **COW BOOKS Nakameguro** — 8.0 → 8.8 — promoted
- **Japan Watercolor Society Annual Exhibition** — 7.3 → 8.1 — promoted
...
- **7月～12月企画展 参加者募集** — 6.67 → 7.47 — promoted
- **Aoyama Farmers Market** — 6.57 → 5.5 — demoted
- **世界堂絵画展2026** — 6.41 → 7.21 — promoted
- **HandMade In Japan Fes** — 6.4 → 5.5 — demoted
- **Comitia** — 6.0 → 6.8 — promoted
- **第29回 アート未来展** — 4.95 → 5.75 — promoted
