...
- **Official/source website**: https://www.jpf.go.jp/j/program/grant.html (verified)
- **Submission process**: Not publicly listed (needs_inquiry)
- **Deadline**: September–October annually (check jpf.go.jp for current cycle) (verified)
...
Japanese government cultural exchange grants for artists resident in Japan. ¥500k–3M depending on program track. Watercolor/painting has track record.

## 5. Existing Fit Notes
Japan-based artist. Urban documentation of Tokyo is a strong cultural exchange narrative. Multiple program tracks — individual artists, collaborative projects.
...
- Deadline: September–October annually (check jpf.go.jp for current cycle) — confirm on the official site before submitting
...
Visit jpf.go.jp for current programs. Application in Japanese required. Start 4 months before deadline.
