...
- **Submission process**: Google Form (linked in article) (verified)
- **Deadline**: Not publicly listed (needs_inquiry)
- **Fees**: Not publicly listed (needs_inquiry)
- **Contact**: Email address provided in form (verified)
...
Open call for original illustration works; accepts diverse artists including beginners; illustration-focused exhibition.
...
- **Submission page:** Google Form (linked in article)
