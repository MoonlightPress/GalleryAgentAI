...
- Opportunity type: Global Photo Publication.
...
Prestigious watercolor / works on paper publisher and platform with periodic prizes, publishing, and portfolio opportunities.

## 5. Existing Fit Notes
Very high-prestige but difficult; useful as a long-term benchmark and possible stretch opportunity.

## 6. Key Points
- Major watercolor / works on paper credibility.
- High difficulty means it should not dominate easy-first strategy.
- Best used as a stretch target after strong sequencing and statement.
...
Research current open opportunities and compare her work to recent selected artists.
