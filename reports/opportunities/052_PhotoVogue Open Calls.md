...
- Opportunity type: Global Online Feature.
...
Global watercolor / works on paper platform associated with Vogue, with periodic open calls and artist visibility opportunities.

## 5. Existing Fit Notes
Useful for international exposure if her work can be framed as poetic documentary, memory, place, or contemporary visual storytelling.

## 6. Key Points
- Global visibility without requiring local gallery access.
- Good for painterly storytelling and atmospheric image series.
- Needs careful project framing, not casual upload.
...
Check current open calls and archive previous selected projects to judge aesthetic fit.
