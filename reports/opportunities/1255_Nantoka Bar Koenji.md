...
- **Official/source website**: https://nantoka.bar/ (verified)
...
- **Contact**: @nantoka_bar (Instagram) — visit nantoka.bar (verified)
...
Koenji bar and cultural space known for zine events, readings, and DIY art programming — part of the neighborhood's countercultural fabric.

## 5. Existing Fit Notes
Informal exhibition and event space — the kind of place where showing work once leads to further introductions.
...
Check their events calendar, attend something, introduce yourself.
