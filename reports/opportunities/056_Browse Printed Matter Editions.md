...
- **Official/source website**: https://www.printedmatter.org/catalog/category/15-pm-fundraising-editions (verified)
...
Candidate link discovered from Printed Matter.

## 5. Existing Fit Notes
Possible fit based on link text: printed matter

## 6. Key Points
- Candidate passed quality gate but remains unverified.
- Fit signals: zine, printed matter
