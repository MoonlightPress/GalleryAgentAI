...
- **Official/source website**: https://www.localgallerybooks.com/about (verified)
- **Submission process**: Not publicly listed (needs_inquiry)
- **Deadline**: 2026-02-23 (verified)
...
- First action: Verify current location/contact and visit with a sample zine.
...
Verify current location/contact and visit with a sample zine.
