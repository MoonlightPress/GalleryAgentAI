...
- **Deadline**: Monday, January 5 (verified)
- **Fees**: Not publicly listed (needs_inquiry)
- **Contact**: Not publicly listed (needs_inquiry)

## 3. Why This May Fit the Artist
- Opportunity type: Global Photobook.
...
Candidate discovered from Printed Matter. Needs manual verification before recommendation.
...
- Keyword hits: artist book / watercolor sequence, zine, printed matter, watercolor / works on paper, book fair, exhibition, memory, architecture, watercolor, drawing
