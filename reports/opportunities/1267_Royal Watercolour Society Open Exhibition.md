...
The world's oldest and most prestigious watercolor society, holding annual open exhibitions open to non-member artists internationally.

## 5. Existing Fit Notes
Direct medium match — the RWS open exhibition is the most prestigious international platform for watercolor watercolor / works on paper, and acceptance is a major CV milestone.

## 6. Key Points
- Highest prestige watercolor exhibition in the world — acceptance is career-defining.
- Open to international non-member artists, making it accessible.
...
Research current open call dates, submission fees, accepted formats, and previous selected works to gauge aesthetic fit.
