...
Candidate discovered from CuratorSpace. Needs manual verification before recommendation.

## 5. Existing Fit Notes
Potential fit based on source context and keyword overlap: zine, open call, submission, watercolor / works on paper, exhibition, place, watercolor / works on paper, open exhibition

## 6. Key Points
- Automatically discovered candidate.
- Needs verification before being treated as actionable.
- Keyword hits: zine, open call, submission, watercolor / works on paper, exhibition, place, watercolor / works on paper, open exhibition

## 7. Submission / Logistics
- **Deadline:** Not publicly listed
- **Fees:** Free
- **Submission page:** https://www.curatorspace.com/opportunities
