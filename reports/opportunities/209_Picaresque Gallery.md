...
Tokyo gallery/shop with art goods focus—uncertain positioning between commercial and exhibition space with limited information available.

## 5. Existing Fit Notes
Geographic match and accessible atmosphere could work, but commercial framing may reinforce the illustrative/surface-level perception you're trying to avoid.

## 6. Key Points
- Gallery-shop hybrid model may blur line between fine art representation and commercial product placement
- Tokyo location aligns with regional interests, but 'approachable art goods ecosystem' suggests surface-level/commercial orientation
- Insufficient information about submission process, fees, exhibition terms, or curatorial standards
...
Research thoroughly before any contact: review past exhibitions, artist roster quality, sales vs exhibition model, and any fee structures.
