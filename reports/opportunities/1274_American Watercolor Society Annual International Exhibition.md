...
- **Official/source website**: https://www.americanwatercolorsociety.org/ (verified)
- **Submission process**: Not publicly listed (needs_inquiry)
- **Deadline**: November 12, 2025 (verified)
...
The most prominent annual international watercolor exhibition in North America, open to artists worldwide.

## 5. Existing Fit Notes
Direct medium match and major international credibility — AWS is recognized globally as a benchmark for serious watercolor practice.

## 6. Key Points
- One of the most recognized international watercolor credentials available.
- Accepts entries from artists worldwide — no geographic restriction.
- Strong alignment with works on paper, intimate scale, and atmospheric watercolor / works on paper.
...
Check current open call window, digital vs. physical submission requirements, fees, and accepted paper sizes.
