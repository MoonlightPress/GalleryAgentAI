...
### Printed Matter — fit 4.0 — high
Artist book and printed matter ecosystem; strong fit if her work becomes book/zine oriented.

- Region: USA
- Best use: artist-book ecosystem / fair research
- Fit tags: artist book, printed matter, zine, small press

### Self Publish, Be Happy — fit 3.0 — high
Strong match for independent photobook and zine culture.

- Region: Global
- Best use: submission research / community reference
- Fit tags: self-publishing, photobook, zine, community

### AKAAKA — fit 2.0 — high
Japanese photobook publisher with serious photography context; useful for quiet, sequence-driven work.

- Region: Japan
- Best use: long-term publisher / benchmark
- Fit tags: Japanese photography, photobook, quiet sequence, serious publication

### Aperture — fit 1.8 — stretch
High-prestige photography institution and publication ecosystem; useful for awards, references, and benchmark artists.

- Region: USA
- Best use: stretch opportunity / research source
- Fit tags: photography, publication, prestige, portfolio prize

### T&M Projects — fit 1.4 — medium-high
Japanese photobook publisher; useful ecosystem reference for publication-oriented photography.

- Region: Japan
- Best use: publisher research / benchmark
- Fit tags: photobook, Japan, printed matter

### VOID — fit 1.4 — medium-high
Photobook publisher with strong visual sequencing culture; good benchmark for atmospheric projects.

- Region: Europe
- Best use: publisher benchmark
- Fit tags: photobook, sequence, Europe

### MACK — fit 0.8 — stretch
Major photobook publisher; probably not immediate, but useful as a long-horizon benchmark.

- Region: UK
- Best use: career benchmark
- Fit tags: photobook, prestige, stretch

## Ecosystem-to-Opportunity Bridge
...
- **Tokyo Art Book Fair** — score 9.6, differentiated 11.7; matched: TOKYO ART BOOK FAIR
- **UTRECHT** — score 9.2, differentiated 11.3; matched: UTRECHT
- **MOUNT ZINE** — score 9.2, differentiated 10.51; matched: MOUNT ZINE
- **flotsam books** — score 8.3, differentiated 10.29; matched: flotsam books
- **POST** — score 8.2, differentiated 9.51; matched: POST
- **TOKIO ART BOOK FAIR 2026** — score 6.0, differentiated 7.84; matched: TOKYO ART BOOK FAIR
...
- **Offprint** — score 8.8, differentiated 9.79; matched: Offprint
- **tata bookshop/gallery** — score 8.2, differentiated 9.33; matched: VOID
- **Self Publish, Be Happy** — score 7.6, differentiated 9.08; matched: Self Publish, Be Happy
- **Aperture | Photography** — score 5.6, differentiated 7.49; matched: Aperture
- **Gallery Conceal Shibuya** — score 6.5, differentiated 7.2; matched: VOID
...
_No current opportunities connected to this ecosystem yet._
...
- **MOUNT ZINE** — score 9.2, differentiated 10.51; matched: MOUNT ZINE
- **flotsam books** — score 8.3, differentiated 10.29; matched: flotsam books
- **B&B Shimokitazawa** — score 8.0, differentiated 9.99; matched: B&B Shimokitazawa
- **POST** — score 8.2, differentiated 9.51; matched: POST
