...
/*
Zines / Artist Books page.

Expected data:
- deploy_data/zine_website_section_final.json

Usage:
import ZineCategoryPage from "./ZineCategoryPage";
<ZineCategoryPage section={zineWebsiteSectionFinal} />
*/
...
export default function ZineCategoryPage({ section }) {
  if (!section) return null;

  const statCards = section.top_stat_cards || [];
  const plan = section.battle_plan || {};
  const phase1 = plan.phase_1_targets || section.practical_solution?.phase_1_targets || [];
