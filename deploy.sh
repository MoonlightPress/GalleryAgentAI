...
for e in profile_sync.py why_hook.py recurring_calendar_engine.py futures_engine.py book_economics_engine.py outreach_kit_engine.py regen.py notify.py visit_tracking.py geoip.py backups.py career_strategy_engine.py peppercorn_preference_engine.py ibm_email_writer.py usage_report.py; do
