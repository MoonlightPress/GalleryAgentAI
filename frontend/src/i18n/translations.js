...
const zh = {
  ...
  'sf.mom.noSubmissionsYet': '尚未记录投递。使用Mochi的反馈按钮或Peppercorn的投递记录开始追踪。',
...
const en = {
  ...
  'sf.mom.venuesInCRM':      'Venues in CRM',
  ...
  'sf.mom.noSubmissionsYet': 'No submissions logged yet. Use Mochi\'s feedback buttons or Peppercorn\'s submission log to start tracking.',
