...
const zh = {
  ...
  'sf.front.read1':          '你已建立起一份每天更新的水彩日记，{ig} 人始终追随；身后有 {pub} 本出版物、{ex} 场东京展览。',
  ...
  'sf.ov.doingWell':         '而且你做得很好：{ex} 场展览、{pub} 项出版，还有 {ig} 人关注的每日水彩日记。这是扎实的作品与真实的受众——比同龄多数画家走得更远。',
  ...
  'sf.sec.oppGap':           '机会缺口分析',
  'sf.sub.oppGap':           '与同类艺术家相比，当前组合中缺少哪些类别？',
...
const ja = {
  ...
  'sf.sec.oppGap':           '機会ギャップ分析',
  'sf.sub.oppGap':           '同類作家と比較して、現在のポートフォリオに不足しているカテゴリは？',
  ...
  'sf.front.read1':          '毎日続く水彩日記には {ig} 人が集まり、{pub} 冊の出版物と {ex} 回の東京での展示があります。',
  ...
  'sf.ov.doingWell':         'しかもよくやっています：展示 {ex} 回、出版 {pub} 件、そして {ig} 人がフォローする毎日の水彩日記。確かな作品と本物の読者を持ち——同世代の多くの画家より先を行っています。',
...
const en = {
  ...
  'sf.sec.oppGap':           'Opportunity Gap Analysis',
  'sf.sub.oppGap':           'What categories is this portfolio missing that comparable artists pursued at this stage?',
  ...
  'sf.front.read1':          "You've built a daily watercolor practice that {ig} people return to, {pub} books behind you, and {ex} Tokyo shows.",
  ...
  'sf.ov.doingWell':         "And you're doing it well: {ex} exhibitions, {pub} publications, and a daily watercolor diary that {ig} people follow. That's a real body of work and a real audience — further along than most painters your age.",
