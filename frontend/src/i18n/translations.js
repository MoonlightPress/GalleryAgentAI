...
const zh = {
  ...
  'pp.contacts.emptyAll':       '系统中暂无联系人。管线发现场地后会自动添加。',
...
const ja = {
  ...
  'pp.contacts.emptyAll':       'まだ連絡先がありません。パイプラインが会場を発見すると自動的に追加されます。',
...
const en = {
  ...
  'pp.contacts.emptyAll':       'No contacts in the system yet. The pipeline adds contacts as it discovers venues.',
