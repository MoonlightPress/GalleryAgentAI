...
const zh = {
  ...
  'hero.sub':                '🌱 今天也要成长。',
  'intro.dismiss':           '关闭',
  'sf.intro.body':           '我是红雀。我在高处观察更大的图景——市场、时机、与你并肩前行的艺术家。我不会告诉你该做什么，我只为你呈现这片风景。',
  'mochi.intro.body':        '我是猫饼。你不在的时候，我替你跑腿——搜寻机会、整理筛选、起草邮件。等你回来，值得你留意的几件已经备好。是三件，而不是五十件。',
  'mochi.poem.0':            '城市静止了一瞬——\n久得足以留住。',
  'mochi.poem.1':            '灰墙，绿水，\n一个停驻的午后。',
  'mochi.poem.2':            '雨改写的，\n笔会记得。',
  'mochi.poem.3':            '小小的房间，长长的光。\n就从此刻开始。',
...
const en = {
  ...
  'sf.intro.body':           'I\'m Saffron. From up here I watch the wider picture — the market, the timing, the artists working alongside you. I don\'t tell you what to do; I just show you the view.',
  'mochi.intro.body':        'I\'m Mochi. While you\'re away I do the legwork — hunting opportunities, sorting them, drafting the emails. When you come back, the few worth your attention are waiting. Three things, not fifty.',
  'mochi.poem.0':            'The city holds still a moment —\nlong enough to keep.',
  'mochi.poem.1':            'Grey walls, green water,\nan afternoon that stays.',
  'mochi.poem.2':            'What the rain rewrites,\nthe brush remembers.',
  'mochi.poem.3':            'Small rooms, long light.\nBegin where you are.',
