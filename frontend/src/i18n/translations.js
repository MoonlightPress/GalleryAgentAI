...
const zh = {
  ...
  'status.message':          '麻薯正在阳光下惬意地打盹。',
  'status.sub':              '稍后再来投喂和玩耍吧！',
  'status.celebrate':        '麻薯听说 {venue} 接受了你！',
  'status.celebrate.sub':    '麻薯很高兴，正在为你转圈！',
  ...
  'hero.sub':                '🌱 今天也要成长。',
  'intro.dismiss':           '关闭',
  'sf.intro.body':           '你好，我是山楂。我替你看看创作生涯的全貌：你现在走到了哪里，已经积累了什么，以及接下来有哪些方向值得留意。来吧，我们一起看看眼前的风景。',
  'mochi.intro.body':        '你好，我是麻薯。我在东京四处游走，探索这里的艺术世界，我找到了几个你或许会喜欢的机会。',
  ...
  'rec.oneMoreLook':                         '麻薯还需要再看一眼才能强力推荐。',
  ...
  'sf.catDesc.direction':    '策略、长期路径与值得积累的基础',
  ...
  'sf.browseIntro':          '山楂眼中你的职业全景。按主题浏览：',
  ...
  'sf.ov.role':              '山楂负责远景——市场、同行、整体格局——好让你安心作画。从高处望去，我看到的是：',
  ...
  'sf.sec.pathway':          '推进策略',
  'sf.sub.pathway':          '通向{goal} · 预计 {timeline}',
  'sf.sec.instagram':        'Instagram 策略',
  'sf.sub.instagram':        '你在平台上的影响力、受众增长空间，以及可以怎样改善。',
  ...
  'sf.mom.traj.stalling':    '平静期',
  'sf.mom.activityChart':    '月度活动',
  'sf.mom.submissions':      '投递',
  'sf.mom.contacts':         '联系',
  'sf.mom.exhibitions':      '展览',
  'sf.mom.shows':            '展览',
  'sf.mom.traj.unknown':     '暂无记录',
  ...
  'sf.actStatus.solo':           '个展',
  'sf.actStatus.group':          '联展',
  'sf.actStatus.exhibition':     '展览',
  ...
  'sf.timing.alreadyPassed': '已过期',
  'sf.timing.quietMonths':   '较清闲的月份',
  'sf.timing.quietNote':     '接下来几个月里最清闲的 — 适合准备',
  ...
  'sf.sec.pricing':          '定价情报',
  'sf.sum.pricing':          '¥31,900–115,500 原作 · ¥2,200 版画 · ¥1,980 画集',
  'sf.pricing.listed':       '在售 {n} 件',
  'sf.pricing.commissions':  '约稿',
  ...
  'sf.sub.oppGap':           '几个也许适合你作品的新方向——完全由你选择。',
  'sf.gap.underrepresented': '目前较少涉及的类别',
  'sf.gap.strengths':        '作品集优势',
  'sf.gap.portfolioFocus':   '作品集当前重心',
  'sf.gap.vs':               '个，预期',
  'sf.gap.expected':         '个',
  'sf.gap.tracked':          '个已追踪',
  ...
  'sf.audience.fact':        '五个平台上稳定且持续增长的受众',
  'sf.audience.ceiling':     '五个账号合计约 233,000——这是触达的上限，不是真实人数，因为账号之间有多少重复关注还没有统计过。按语言分，大约 116,500 人用中文关注你，116,300 人用英文关注你，几乎持平。',
  ...
  'sf.label.prepLeadTimes':  '需要提前多久准备',
  'sf.label.rolling':        '随时开放／滚动征集（{n} 个）',
  'sf.label.requiresNow':    '当下需要做的',
  'sf.label.bottleneck':     '瓶颈：',
  'sf.label.rightIf':        '适合条件：',
  'sf.label.saffronView':    '山楂的视角',
  'sf.label.whatBlocking':   '当前阻碍',
  'sf.label.nextMove':       '最重要的下一步',
  'sf.label.openQNote':      '这些山楂看不到——但你可以告诉她。你回答的任何一项，她都会立刻纳入分析。',
  ...
  'sf.grant.title':          '资助资源',
  'sf.grant.summary':        '很多艺术家只是因为不知道有哪些资助项目，就错过了申请机会。',
  ...
  'pp.stmt.note':            '这段文字为麻薯起草的每封联络邮件、每封求职信、每个由麻薯生成的机会描述提供素材。真实具体的自述能产出听起来像你的文字。通用的自述只会产出通用的文字。',
  'pp.stmt.placeholder':     '写一段关于你的创作实践的简短自述…',
  'pp.goals.empty':          '胡椒粒还不知道你的目标。你在为什么努力？',
  'pp.goals.firstNote':      '山楂会用这些来精化她的分析。',
  ...
  'pp.prefs.note':  '胡椒粒了解得越多，山楂的分析就越精准 — 但不需要着急。更改将在下次更新时生效。',
  ...
  'pp.intro.dismiss':          '关闭',
  'pp.intro.body':             '我是胡椒粒。这是你安静的角落——把正在发生的事、你期待的方向告诉我，我会让麻薯和山楂真正读懂你。这里没有急事，我会记住一切。',
  ...
  // ── Today's Focus ───────────────────────────────────────────────────────
  'tf.title':                  '今日重点',
  'tf.sub':                    '麻薯为你找到了三件值得关注的事。',
  'tf.subN':                    '麻薯为你找到了 {n} 件值得关注的事。',
  'tf.open':                   '打开 →',
  'tf.visit':                  '访问 →',
  ...
  'people.group.high':   '优先联系',
  'people.group.medium': '值得联系',
  'people.group.low':    '保持关注',
  'people.empty':    '还没有可联系的人 —— 麻薯正在收集名单。',
  ...
  'sf.mile.sub':          '看看你离下一个里程碑还有多远。',
  'sf.mile.followers':    'Instagram 粉丝',
  'sf.mile.shows':        '联展',
  'sf.mile.pubs':         '出版物',
...
const ja = {
  ...
  'sf.mom.traj.stalling':    '静かな時期',
  'sf.mom.activityChart':    '月別活動',
  'sf.mom.submissions':      '応募',
  'sf.mom.contacts':         '連絡',
  'sf.mom.exhibitions':      '展示',
  'sf.mom.shows':            '展示',
  'sf.mom.traj.unknown':     '記録なし',
  ...
  'sf.timing.alreadyPassed': '締切済み',
  'sf.timing.quietMonths':   '静かな月',
  'sf.timing.quietNote':     'これからの数か月で最も静か — 準備向き',
  ...
  'sf.sec.pricing':          '価格情報',
  'sf.sum.pricing':          '¥31,900–115,500 原画 · ¥2,200 プリント · ¥1,980 画集',
  'sf.pricing.listed':       '{n}点を出品中',
  'sf.pricing.commissions':  '依頼制作',
  ...
  'sf.sec.pathway':          '進め方',
  'sf.sub.pathway':          '{goal} へ · 想定 {timeline}',
  ...
  'sf.audience.fact':        '5つのプラットフォームにまたがる、確立された、伸び続けるフォロワー',
  'sf.audience.ceiling':     '5つのアカウント合計で約233,000人——これは到達できる上限であり、実際の人数ではありません。アカウント間でどれだけ重複しているかはまだ測定されていないためです。言語別に見ると、中国語であなたをフォローしている人が約116,500人、英語では約116,300人と、ほぼ拮抗しています。',
  ...
  'people.group.high':   '優先して連絡',
  'people.group.medium': '連絡する価値あり',
  'people.group.low':    '気に留めておく',
  ...
  'sf.mile.followers':    'Instagram フォロワー',
  'sf.mile.shows':        'グループ展',
  'sf.mile.pubs':         '出版物',
...
const en = {
  ...
  'sf.intro.body':           'Hi, I\'m Saffron. I keep an eye on the bigger picture of your work — where you stand, what you\'ve built, and the doors worth walking toward next. Come up, and I\'ll show you the view.',
  ...
  'sf.mom.traj.stalling':    'A quiet stretch',
  'sf.mom.activityChart':    'Monthly Activity',
  'sf.mom.submissions':      'Submissions',
  'sf.mom.contacts':         'Contacts',
  'sf.mom.exhibitions':      'Exhibitions',
  'sf.mom.shows':            'Shows',
  'sf.mom.traj.unknown':     'Not yet measured',
  ...
  'sf.actStatus.solo':           'Solo show',
  'sf.actStatus.group':          'Group show',
  // Two shows on the profile are recorded as "group/solo not specified on
  // source". They stay unspecified rather than being promoted to solo.
  'sf.actStatus.exhibition':     'Exhibition',
  ...
  'sf.timing.alreadyPassed': 'Date already passed',
  'sf.timing.quietMonths':   'Quieter Months',
  'sf.timing.quietNote':     'lightest of the months ahead — good for prep',
  ...
  'sf.sum.pricing':          '¥31,900–115,500 originals · ¥2,200 prints · ¥1,980 books',
  'sf.pricing.listed':       '{n} listed',
  'sf.pricing.commissions':  'Commissions',
  ...
  'sf.sec.pathway':          'Strategies',
  'sf.sub.pathway':          'Toward {goal} · estimated {timeline}',
  ...
  'sf.audience.fact':        'An established, growing following across five platforms',
  ...
  'people.group.high':   'High priority',
  'people.group.medium': 'Worth reaching out to',
  'people.group.low':    'Keep on the radar',
  ...
  'sf.mile.followers':    'Instagram Followers',
...
// Exposed for the persona-name leak guard (personaNames.test.js): the zh UI must
// never show an English persona name or an old/renamed one.
export const LOCALES = dicts
