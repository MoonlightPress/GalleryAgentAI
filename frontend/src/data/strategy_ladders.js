...
export const STATES = {
  ...
  g_representation: {
    label: T('A gallery that sells on her behalf', '一家代理她销售的画廊'),
  ...
  a_found: {
    label: T('An audience that found her', '一群自己找上来的读者'),
  ...
  a_motion: {
    ...
    detail: T('Watercolour spreading into wet paper is one of the very few things a still image cannot show, and it is the single change on this ladder that asks for no extra painting — the camera watches work already being done.', '水彩在湿纸上化开，是静止图像几乎唯一拍不到的东西；而且这是这条阶梯上唯一不要求她多画一张的改变——镜头拍的，是本来就在做的事。'),
    treatment: {
      open: T('Why this one matters more than the rest', '为什么这一级比其它几级都重要'),
      hide: T('Close', '收起'),
      blocks: [
        { label: T('What it changes', '它改变了什么'),
          text: T('A finished painting competes with every other finished painting. A painting being made competes with almost nothing, because the moment pigment hits wet paper cannot be screenshotted, described, or reproduced by anyone else. It is the one thing in her practice that is structurally hers.', '一张画完的画，要和所有画完的画竞争。一张正在被画的画几乎没有对手——颜料落在湿纸上的那一瞬间，没法截图、没法转述，也没有别人能复制。这是她的实践里，结构上唯一属于她自己的东西。'),
        },
        { label: T('Why it costs nothing', '为什么它没有额外成本'),
          text: T('Every other state on this ladder asks for something new — a series to invent, a platform to learn, a person to write to. This one asks for a phone on a stand pointing at a desk she is already sitting at, for work she is already doing daily. The material is a by-product.', '这条阶梯上其它每一级都要求一件新的事——想一个系列、学一个平台、给一个人写信。这一级只要求一部架好的手机，对着她本来就坐着的桌子，拍她本来每天都在做的事。素材是副产品。'),
        },
  ...
  a_second: {
    label: T('A second audience somewhere else', '在别处的第二群受众'),
    detail: T('Architecture and light need no translation, and the paintings already exist. Almost all of the audience currently sits on one platform.', '建筑和光不需要翻译，而画已经画好了。目前几乎全部受众都集中在一个平台上。'),
  },
  a_inbound: {
    label: T('An audience that arrives without being asked', '不用去找、自己会来的受众'),
    detail: T('The state the rest of this ladder is for. At scale a print run stops being a gamble — her best route breaks even at 109 copies, which is one follower in 240 today and one in 4,600 at half a million.', '这条阶梯上其余的一切，都是为了到达这个状态。到了这个规模，印一版书不再是赌博——她最好的印制方案 109 本回本，按今天的受众是 240 人里有 1 人，到五十万时是 4,600 人里有 1 人。'),
  },
  ...
  l_lookbook: {
    ...
    detail: T('Ten to twenty works shown as product mockups, one PDF. An art director cannot picture a painting on a notebook cover; a mockup does it for them. Nothing in her record is one.', '十到二十件作品做成产品效果图，一份 PDF。美术总监没法凭空想象一张画印在笔记本封面上是什么样，效果图替他想。她的记录里还没有这样一份东西。'),
  },
  l_findable: {
  ...
  l_repeat: {
    label: T('Repeat clients and a rate she sets', '回头客，和一个由她定的价'),
