...
export const PRICING_INTELLIGENCE = {
  ...
  what_affects_price: [
    ...
    { factor: "Audience", "factor_zh": "受众", "factor_ja": "オーディエンス", impact: "medium", note: "An engaged following is a genuine asset: it shows that people choose to keep up with the work. Yours runs across four places at once: about 89,300 on X, 44,000 on Xiaohongshu, 27,000 on the Instagram diary, and 7,500 on Bilibili for the painting videos — roughly 168,000 follows in total. Sales conversion has not been measured, so this is evidence of attention, not a claim about collectors or buyers.", "note_zh": "持续关注你的受众是一项真实的资产：这说明有人主动选择继续看你的作品。关注分布在四个平台：X 约 8.93 万、小红书约 4.4 万、Instagram 日记约 2.7 万、B 站绘画视频约 7,500——合计约 16.8 万次关注。销售转化尚未测量，因此这只能证明关注度，不能据此断言藏家或买家行为。", "note_ja": "継続的に作品を見てくれるフォロワーは確かな資産です。人々が自ら作品を追い続けていることを示します。Xに約89,300、REDに約44,000、Instagramの日記に約27,000、Bilibiliの制作動画に約7,500、合計およそ168,000のフォローがあります。販売への転換は測定されていないため、これは関心の証拠であり、コレクターや購入者についての断定ではありません。" },
...
export const PRESS_KIT = {
  ...
  fact_sheet: {
    ...
    zh: [
      ...
      "受众：四个账号合计约 16.8 万关注——X @GegYjiji（8.93 万）、小红书（4.4 万）、Instagram @gegyjiji（2.7 万）、B 站（7,500）",
