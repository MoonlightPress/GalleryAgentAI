  ...
  groups: [
    {
      ...
      entries: [
        ...
        },
        {
          ...
          why_fit: "Small, kind, everyday moments drawn with animals — bears, dinosaurs, rabbits as often as cats — and the same warmth that runs through your interiors. Her audience would recognise yours instantly.",
          why_fit_zh: "用动物讲微小而善意的日常瞬间——熊、恐龙、兔子和猫一样多——那份温暖和贯穿你室内画的是同一种。她的受众一眼就会认出你的。",
        ...
        {
          name: "Puuung (퍼엉)",
          who: "Korean illustrator behind the Love Is series — pencil and digital colour, not watercolour, but the same subject: small everyday moments of love at home.",
          who_zh: "韩国插画家，《Love Is》系列作者——用铅笔加数码上色，并不是水彩，但画的是同一件事：家里那些微小的爱意瞬间。",
      ...
      entries: [
        {
          ...
          who_zh: "《Tide from China Part1》同展者（东京，2023）；用水彩与马克笔创作的插画家，出版过画集《オーロラ曲》（2021）。代表作有《四季》和《蜥蜴と猫》。",
...
export const COLLECTOR_ECOSYSTEM = {
  ...
  channels: [
    ...
    },
    {
      ...
      fee_zh: "每笔订单 6.6% + 40 日元（标准版：3.0% 服务费 + 3.6% + 40 日元支付费）。2026-09-08 核实。",
    ...
    },
    {
      ...
      what_zh: "亚洲最大的艺术书与 zine 书展，在东京都现代美术馆举办。观众正是你的本土生态——收藏 zine、艺术书和印刷品、并会当场购买的人。艺术家申请参展，而真正要盯的是申请窗口，不是展期本身：2026 年这一届的申请已于 2026 年 6 月 7 日截止，展会在 2027 年 1 月举行，下一个申请窗口大约在 2027 年年中。申请不等于一定有摊位——报名人数超出时会做筛选——而且展期内摊位需要你自己看顾。",
    ...
    },
    {
      ...
      fee_zh: "含税 10.67%，按含运费的总结算金额收取——2025 年 11 月 5 日从「11%、不含运费」改成现制，所以旧数字会低估。提现费 176–275 日元。",
    ...
    },
    {
      ...
      fee: "10.56% (minne PLUS) or 10.89% including tax, charged on item + options + shipping. Transfer ¥220.",
      fee_zh: "含税 10.56%（minne PLUS）或 10.89%，按商品 + 选项 + 运费计算。提现费 220 日元。",
    ...
    },
    {
      ...
      what_zh: "东京有一小批艺术书店以寄售方式代销自出版艺术书——UTRECHT（位于涩谷，也是 TABF 的共同主办方）是知名代表。UTRECHT 并没有公开寄售政策，所以在他们那里具体怎么做、抽成多少，其实是不清楚的；他们唯一公开的批发页面走的是相反方向。要知道答案，只能去问。",
...
export const PRESS_KIT = {
  ...
  fact_sheet: {
    en: [
      ...
      "Audience: about 168,000 follows across four accounts — X @GegYjiji (89.3k), Xiaohongshu (44k), Instagram @gegyjiji (27k), Bilibili (7.5k)",
